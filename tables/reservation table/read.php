            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        ...
                        <p><b><?php echo $row["stadium_type"]; ?></b></p>
                    </div>
                    <div class="form-group">
                        <label>Stadium Capacity</label>
                        <p><b><?php echo $row["stadium_capacity"]; ?></b></p>
                    </div>
                    <div class="form-group">
                    ...
                    <p><a href="reservation.php" class="btn btn-primary">Back</a></p>
                </div>
            </div>        
        </div>
    </div>
